...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[UITabBar appearance] setTintColor:[UIColor colorWithRed:0.510 green:0.557 blue:0.063 alpha:1.000]];
    [[UINavigationBar appearance] setBarTintColor:[UIColor colorWithRed:0.788 green:0.400 blue:0.404 alpha:1.000]];
